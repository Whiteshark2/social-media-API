...
const profilePicturePATH = "uploads/profile-picture";
...
module.exports.update = asyncHandler(async (req, res) => {
  ...
  if (user) {
    const uploads = configureMulter(profilePicturePATH, "profilePicture");
    ...
    uploads(req, res, async function (err) {
      ...
      if(req.file){
        ...
        user.profilePicture=profilePicturePATH +'/'+req.file.filename
      }
